...
class FetchApiYear extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = event => {
    fetch(`http://numbersapi.com/${this.state.input}/year?json`)
     ...
     <div className="data" >
        <form onSubmit={this.handleSubmit}>
          <div className="form-group">
            <p className="paragraph">Do you want to know all the facts about your wanted year(ex. 1999)?<br />If you enter negative number you will go to BC<br/>Let's input it in the form<strong> ONLY NUMBER!</strong></p>
            <label>
        <input
        ...
        {this.state.number === '' ? (<p></p>) : ( 
         <div className="alert alert-success">
          ...
          <ul>
            ...
            {this.state.number.number >= 0 ? (<li><h4>Year:</h4>{this.state.number.number}</li>) : (<li><h4>Year:</h4>{-this.state.number.number}(BC)</li>) }<br />
