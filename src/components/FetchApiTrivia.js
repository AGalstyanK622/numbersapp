...
class FetchApiTrivia extends Component {
  constructor(props) {
    super(props);
          ...
          <div className="data">
            <form onSubmit={this.handleSubmit}>
              <div className="form-group">
                <p className="paragraph">Do you want to know all the facts about your wanted number?(ex. 255)<br />Let's input it in the form<strong> ONLY NUMBER!</strong></p>
                <label>
                  <input
