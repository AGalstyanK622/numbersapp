...
class FetchApiDate extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = event => {
    ...
    fetch(`http://numbersapi.com/${this.state.input}/date?json`)
      ...
      <Grid>
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-group">
            <p className="paragraph">Do you want to know all the facts about your wanted date(ex. for january 1 input 1,for december 25 input 360)?<br />Let's input it in the form<strong> ONLY NUMBER!</strong></p>
            <label>
          <input
        ...
        <div className="alert alert-success">
          <h4 className="alert-heading">Well done! Number is {this.state.number.number}.</h4>
          <ul>
            {this.state.number.found === true ? (<li><h4>Found:</h4>True</li>) : (<li><h4>Found:</h4>False</li>) }<br />
            <li><h4>Year</h4>{this.state.number.year} </li><br />
